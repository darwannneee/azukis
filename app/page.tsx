  ...
  return (
    <main className="pointer-events-none n">
      <div className="bg-black relative h-screen" style={{ aspectRatio: '6151 / 1080' }}>
        ...
        <img src={shao1.src} className="absolute z-20 duration-200 select-none left-1" style={{ height: '47.6%', left: '22.8%', bottom: '6%', opacity: (scrollPosition > 100 && scrollPosition <= 1600) ? 1 : 0 }} />
